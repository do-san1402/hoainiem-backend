<div class="row ps-4 pe-4">
    ...
    <input type="hidden" name="theme" value="{{$active_theme->default_theme}}">
    ...
    <div class="col-md-12 mt-3">
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                ...
                <select name="page" id="page" class="form-control" onchange="loadPagePositions(this.value)" required>
